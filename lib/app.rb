...
# Choisir 5 handles au hasard et envoyer yn tweet !
...
# take 5 journalists' handles randomly
five_journalists = journalists.sample(5)
# send a tweet to the 5 handles
five_journalists.each do |name|
	puts client.update ("Hi #{name}, I'm doing a test for my school. Have a nice day ! #bonjour_monde")
end
...
client.search('#bonjour_monde', result_type: "recent").take(25).collect do |i|
	puts client.favorite(i.id)
end
